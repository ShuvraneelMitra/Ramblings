---
layout: post
title: "Interesting Internet Artifacts"
date: 2026-02-21
categories: [Random]
description: "This is where your attention span comes in clutch"
---
...
1. [Neal.fun](https://neal.fun/): I personally believe that no "fun internet websites" list can be complete without a mention of the legendary neal.fun page. I personally love the "[Draw a Perfect Circle](https://neal.fun/perfect-circle/)" challenge the most, not only because it reminds me of [A Perfect Circle](https://en.wikipedia.org/wiki/A_Perfect_Circle), but also because figuring out a formula to calculate a percentage score for an "almost-circle" that makes sense is a nice math challenge.

2. [sandtris](https://sandtris.com/): Tetris, but with a twist. Do try it out.

3. [pointlesssites](https://www.pointlesssites.com/): A huge catalogue of "interesting" stuff that is enough to bash _this_ list into obsolescence. Have fun exploring the website, for you might look up from your screen to find 2 years have passed by while you were digging into rabbitholes in this page.

4. [The Evolution of Trust](https://ncase.me/trust/): Simply put, a cool guide to Game Theory without seeming like one.

5. [We Become What We Behold](https://ncase.itch.io/wbwwb): A nice commentary on how [yellow journalism](https://en.wikipedia.org/wiki/Yellow_journalism) impacts how we feel about others in society, and how mass media has a huge leverage on the general public sentiment towards an event or a group of people. Makes you stop and think.

6. [Nicky Case](https://ncase.me/): Another creator who makes nice engaging "games" which sometimes double up as learning tools. The above two entries are actually made by Case himself but I put them separately because I discovered them independently of his general website where these are also hosted.

7. [Zen Pencils](https://www.zenpencils.com/): A set of ~200 beautiful webcomics, each of which takes a memorable quote, and illustrates life into it.

8. [Math With Bad Drawings](https://mathwithbaddrawings.com/): I can almost smell the marker ink from those drawings.
